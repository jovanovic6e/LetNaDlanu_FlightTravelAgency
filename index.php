...
<body onload="UcitajStranu()">
    ...
    <div class="container text-center">
        ...
        <main>
            ...
            <!-- top ponude -->
            <h1 class="naslov" id="topPonuda">Top ponude</h1>
            <div class="container text-center">
                <div class="row">
                    <div class="col">
                        <div class="jumbotronTopPonuda" id="topPonuda">
                            <div class="topPonuda">
                                <div class="topPonudaBaner">
                                    <img src="topPonudeBaneri/zante.jpg" alt="topPonudaBaner1" class="topPonudaBaner">
                                </div>
                                <div class="topPonudaOpis">
                                    ...
                                    if(isset($_SESSION['user_name']))
                                    {
                                        ?>
                                        <form action="">
                                        <h5 class="lokacijaOdDoTop"><?php echo "$pocetnaDestinacijaTop[0]"?> - <?php echo "$krajnjaDestinacijaTop[0]"?></h5>
                                        <h5 class="datumPolaskaTop">
                                            <?php 
                                            $datumP = $datumPolaskaTop[0];
                                            $timestamp = strtotime($datumP);
                                            $formDateP = date('d.m.Y',$timestamp);
                                            echo $formDateP;
                                            ?>
                                        </h5>
                                        <h5 class="cenaTop"><?php echo "$cenaTop[0]"?>&euro;</h5>
                                        <input type="submit" class="rezervisiTop" value="REZERVIŠI ODMAH">
                                        </form>
                                        <?php
                                    }
                                    else
                    ...
                    <div class="col">
                        <div class="jumbotronTopPonuda" id="topPonuda">
                            <div class="topPonuda">
                                <div class="topPonudaBaner">
                                    <img src="topPonudeBaneri/moskva.jpg" alt="topPonudaBaner1" class="topPonudaBaner">
                                </div>
                                <div class="topPonudaOpis">
                                <?php
                                    if(isset($_SESSION['user_name']))
                                    {
                                        ?>
                                        <form action="">
                                        <h5 class="lokacijaOdDoTop"><?php echo "$pocetnaDestinacijaTop[1]"?> - <?php echo "$krajnjaDestinacijaTop[1]"?></h5>
                                        <h5 class="datumPolaskaTop">
                                            <?php 
                                            $datumP = $datumPolaskaTop[1];
                                            $timestamp = strtotime($datumP);
                                            $formDateP = date('d.m.Y',$timestamp);
                                            echo $formDateP;
                                            ?>
                                        </h5>
                                        <h5 class="cenaTop"><?php echo "$cenaTop[1]"?>&euro;</h5>
                                        <input type="submit" class="rezervisiTop" value="REZERVIŠI ODMAH">
                                        </form>
                                        <?php
                                    }
                    ...
                    <div class="col">
                        <div class="jumbotronTopPonuda" id="topPonuda">
                            <div class="topPonuda">
                                <div class="topPonudaBaner">
                                    <img src="topPonudeBaneri/minhen.jpg" alt="topPonudaBaner1" class="topPonudaBaner">
                                </div>
                                <div class="topPonudaOpis">
                                <?php
                                    if(isset($_SESSION['user_name']))
                                    {
                                        ?>
                                        <form action="">
                                        <h5 class="lokacijaOdDoTop"><?php echo "$pocetnaDestinacijaTop[2]"?> - <?php echo "$krajnjaDestinacijaTop[2]"?></h5>
                                        <h5 class="datumPolaskaTop">
                                            <?php 
                                            $datumP = $datumPolaskaTop[2];
                                            $timestamp = strtotime($datumP);
                                            $formDateP = date('d.m.Y',$timestamp);
                                            echo $formDateP;
                                            ?>
                                        </h5>
                                        <h5 class="cenaTop"><?php echo "$cenaTop[2]"?>&euro;</h5>
                                        <input type="submit" class="rezervisiTop" value="REZERVIŠI ODMAH">
                                        </form>
                                        <?php
                                    }
                    ...
                    <div class="col">
                        <div class="jumbotronTopPonuda" id="topPonuda">
                            <div class="topPonuda">
                                <div class="topPonudaBaner">
                                    <img src="topPonudeBaneri/barcelona.png" alt="topPonudaBaner1" class="topPonudaBaner">
                                </div>
                                <div class="topPonudaOpis">
                                <?php
                                    if(isset($_SESSION['user_name']))
                                    {
                                        ?>
                                        <form action="">
                                        <h5 class="lokacijaOdDoTop"><?php echo "$pocetnaDestinacijaTop[3]"?> - <?php echo "$krajnjaDestinacijaTop[3]"?></h5>
                                        <h5 class="datumPolaskaTop">
                                            <?php 
                                            $datumP = $datumPolaskaTop[3];
                                            $timestamp = strtotime($datumP);
                                            $formDateP = date('d.m.Y',$timestamp);
                                            echo $formDateP;
                                            ?>
                                        </h5>
                                        <h5 class="cenaTop"><?php echo "$cenaTop[3]"?>&euro;</h5>
                                        <input type="submit" class="rezervisiTop" value="REZERVIŠI ODMAH">
                                        </form>
                                        <?php
                                    }
                    ...
                    <div class="col">
                        <div class="jumbotronTopPonuda" id="topPonuda">
                            <div class="topPonuda">
                                <div class="topPonudaBaner">
                                    <img src="topPonudeBaneri/ny.jpg" alt="topPonudaBaner1" class="topPonudaBaner">
                                </div>
                                <div class="topPonudaOpis">
                                <?php
                                    if(isset($_SESSION['user_name']))
                                    {
                                        ?>
                                        <form action="">
                                        <h5 class="lokacijaOdDoTop"><?php echo "$pocetnaDestinacijaTop[4]"?> - <?php echo "$krajnjaDestinacijaTop[4]"?></h5>
                                        <h5 class="datumPolaskaTop">
                                            <?php 
                                            $datumP = $datumPolaskaTop[4];
                                            $timestamp = strtotime($datumP);
                                            $formDateP = date('d.m.Y',$timestamp);
                                            echo $formDateP;
                                            ?>
                                        </h5>
                                        <h5 class="cenaTop"><?php echo "$cenaTop[4]"?>&euro;</h5>
                                        <input type="submit" class="rezervisiTop" value="REZERVIŠI ODMAH">
                                        </form>
                                        <?php
                                    }
